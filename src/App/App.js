...
class App extends Component {
  ...
  fetchFolders = () => {
    fetch('https://noteful-client-1.herokuapp.com/api/folders')
      .then(res => res.json())
      .then(resJson =>
        this.setState({
          folders: resJson
  ...
  fetchNotes = () => {
    fetch('https://noteful-client-1.herokuapp.com/api/notes')
      .then(res => res.json())
      .then(resJson =>
        this.setState({
          notes: resJson
  ...
  handleDeleteNote = id => {
    const url = `https://noteful-client-1.herokuapp.com/api/notes/${id}`
    fetch(url, {
      method: 'delete',
      headers: {
